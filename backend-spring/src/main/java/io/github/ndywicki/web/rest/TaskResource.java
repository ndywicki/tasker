package io.github.ndywicki.web.rest;

import io.github.ndywicki.domain.Task;
import io.github.ndywicki.repository.TaskRepository;
import io.github.ndywicki.web.rest.util.HeaderUtil;
import io.github.ndywicki.web.rest.util.ResponseUtil;
...
public class TaskResource {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new task,
     *  or with status 400 (Bad Request) if the task has already an ID
